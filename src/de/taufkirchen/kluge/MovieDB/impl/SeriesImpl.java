 ...
 * <ul>
 *   <li>{@link de.taufkirchen.kluge.MovieDB.impl.SeriesImpl#getID <em>ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SeriesImpl extends EObjectImpl implements Series {
	...
	protected EClass eStaticClass() {
		return MovieDBPackage.Literals.SERIES;
	}
	...
	public void setID(Integer newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MovieDBPackage.SERIES__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MovieDBPackage.SERIES__ID:
				return getID();
		}
